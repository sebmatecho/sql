...
SELECT * FROM vendor_booth_assignments vba
...
SELECT vendor_id, count(*) as booth_rented_count FROM vendor_booth_assignments 
GROUP BY vendor_id
...
SELECT c.customer_id, customer_first_name, customer_last_name, sum(quantity*cost_to_customer_per_qty) as customer_expense
FROM customer_purchases cp
LEFT JOIN customer c ON c.customer_id = cp.customer_id 
GROUP BY c.customer_id
HAVING customer_expense > 2000
ORDER BY customer_last_name, customer_first_name
